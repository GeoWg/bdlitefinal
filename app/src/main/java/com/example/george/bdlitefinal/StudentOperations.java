package com.example.george.bdlitefinal;
...
public class StudentOperations {
    ...
    public Student addStudent(String name){
        ...
        Cursor cursor = database.query(SimpleBDWrapper.STUDENTS, STUDENT_TABLE_COLUMNS, SimpleBDWrapper.STUDENT_ID + " = " + studId, null, null,null,null);
        cursor.moveToFirst();
    ...
    public void deleteStudent(Student comment){
        ...
        database.delete(SimpleBDWrapper.STUDENTS,SimpleBDWrapper.STUDENT_ID + " = " + id,null);
    }
